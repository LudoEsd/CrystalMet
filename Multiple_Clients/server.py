...
COMMANDS = {'help':['Affiche une aide'],
            'list':['List les junky'],
            'select':['Selectionne un junky par son index'],
            'quit':['Stop la connection avec le junky selectionner'],
...
class MultiServer(object):
    ...
    def get_target(self, cmd):
        ...
        try:
            ...
            return None, None
        print("connection reussie avec " + str(self.all_addresses[target][2]))
        return target, conn
    ...
    def send_target_commands(self, target, conn):
        """ Connection avec la remote target client 
        :param conn: 
        :param target: 
        """
        conn.send(str.encode(" "))
